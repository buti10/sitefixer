# app/modules/repair_beta/wp_routes.py
...
# Falls du schon Helper hast: nutze deine bestehenden SFTP/SSH-Helfer.
# Unten ist "minimal robust" – passe ggf. an deine bestehende SFTP-Klasse an.

...
const FixMaintenance = defineAsyncComponent(() => import("../fixes/maintenance/FixMaintenance.vue"));
const FixPermissions = defineAsyncComponent(() => import("../fixes/permissions/FixPermissions.vue"));
const FixDropins = defineAsyncComponent(() => import("../fixes/dropins/FixDropins.vue"));
const FixCoreIntegrity = defineAsyncComponent(() => import("../fixes/core/FixCoreIntegrity.vue"));
const FixCoreReplace = defineAsyncComponent(() => import("../fixes/core/FixCoreReplace.vue"));
